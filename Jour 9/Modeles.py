"""
Modeles.py — The MODEL layer of our MVC architecture.
...
Responsibility:
    ...
    - The Controller (Gestionnaire_Tache_Avance_PyQt.py) calls these methods and passes results to Views

MVC Flow in this app:
    User action → Controller (Gestionnaire_Tache_Avance_PyQt.py)
                → Model (Modeles.py) — business logic + DB calls
